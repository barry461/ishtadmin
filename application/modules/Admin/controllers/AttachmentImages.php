...
class AttachmentImagesController extends BackendBaseController
{
    ...
    {
        return function (AttachmentImagesModel $item) {

           $item->slice_status = AttachmentImagesModel::SLICE_TIPS[$item->slice_status];
    ...
    {
        return AttachmentImagesModel::class;
    }
