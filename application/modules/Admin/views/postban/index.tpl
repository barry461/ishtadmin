                ...
                <div class="layui-card-body">
                    <table class="layui-table"
                        ...
                        <tr>
                            ...
                            <th lay-data="{field:'aff',align:'center'}">aff</th>
                            <th lay-data="{field:'num',align:'center'}">违规次数</th>
                            <th lay-data="{field:'ban_status',align:'center'}">禁言状态</th>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    ...
                    <input lay-verify="required" placeholder="违规次数" name="num"
                           value="{{=d.num }}" class="layui-input">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    ...
                    <input placeholder="更新时间" name="updated_at"
