            ...
            <div class="layui-card">
                ...
                <div class="layui-form layui-card-header layuiadmin-card-header-auto">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="search[router]" placeholder="请输入"
                                       autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline">
                ...
                <div class="layui-card-body">
                    <table class="layui-table"
                           lay-data="{url:'{%url('listAjax')%}',limit:1000, page:true, id:'test',toolbar:'#toolbar'}"
                        ...
                        <tr>
                            ...
                            <th lay-data="{field:'sort',width:100,edit:true}">排序</th>
                            <th lay-data="{field:'status_str',width:120}">状态</th>
    ...
    <form class="layui-form form-dialog" action="" lay-filter="form-save">
        ...
        <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    ...
                    <input lay-verify="required" placeholder="路由" name="router"
                           value="{{=d.router }}" class="layui-input">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    ...
                    {%html_options options=FlutterRouterModel::STATUS%}
                    </select>
                </div>
            </div>
        </div>
                    ...
                    case 'edit':
                        lazy('#user-edit-dialog')
                            ...
                            .laytpl(function () {
                                ...
                                Util.uploader('button.but-upload-img', "{%url('upload/upload')%}", upload, $);
                            });
                        break;
                }
            })
