                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="where[mid]" placeholder="请输入"
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <select name="where[type]">
                                    {%html_options options=MetasModel::TYPE%}
                                </select>
                            </div>
                        </div>
                        <div class="layui-inline">
                ...
                <div class="layui-card-body">
                    <table class="layui-table"
                        ...
                        <tr>
                            ...
                            <th lay-data="{field:'description'}">description</th>
                            <th lay-data="{field:'count'}">count</th>
                    ...
                    <script type="text/html" id="operate-toolbar">
                        <div class="operate-toolbar">
                            ...
                            <a data-pk="{{=d.mid}}" lay-event="del">删除</a>
                        </div>
                    </script>
                </div>
            </div>
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    ...
                    <input placeholder="description" name="description"
                           value="{{=d.description }}" class="layui-input">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    ...
                    <input placeholder="count" name="count"
                           value="{{=d.count }}" class="layui-input">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    ...
                    <input placeholder="order" name="order"
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    ...
                    <input placeholder="parent" name="parent"
                           value="{{=d.parent }}" class="layui-input">

                </div>
            </div>
        </div>
        <div class="layui-form-item layui-hide">
            <input type="hidden" name="_pk" value="{{=d.mid}}">
