                ...
                <div class="layui-form layui-card-header layuiadmin-card-header-auto">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <select name="where[type]" lay-search="" >
                                    ...
                                    {%html_options options=InfoTypeModel::TYPE %}
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <select name="where[category]" lay-search="" data-value="{{=d.category}}">
                                    <option value="">全部</option>
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                ...
                                <select name="where[status]" lay-search="" >
                                    <option value="">全部</option>
                                    {%html_options options=InfoTypeModel::STATUS_ARR %}
                                </select>
                ...
                <div class="layui-card-body">
                    <table class="layui-table"
                        ...
                        <tr>
                            ...
                            <th lay-data="{field:'type_str'}">分类</th>
                            <!--
                            <th lay-data="{field:'name'}">资源类型名字</th>
                            -->
                            <th lay-data="{field:'category_str'}">资源分类</th>
                            <th lay-data="{field:'status_str'}">状态</th>
                            <th lay-data="{field:'sort',edit:true}">排序</th>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input placeholder="名称" name="name"
            ...
            <div class="layui-inline">
                <label class="layui-form-label">分类</label>
                <div class="layui-input-inline">
                    <select name="type" lay-search="" data-value="{{=d.type}}">
                        <option value="">全部</option>
                        {%html_options options=InfoTypeModel::TYPE %}
                    </select>
