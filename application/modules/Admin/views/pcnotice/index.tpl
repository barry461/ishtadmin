                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <select name="where[pos]" id="">
                                    ...
                                    {%html_options options=PcNoticeModel::POS%}
                                </select>
                            </div>
                        </div>
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <select name="where[type]" id="">
                                    <option value="">全部</option>
                                    {%html_options options=PcNoticeModel::TYPE%}
                                </select>
                            </div>
                        </div>
                        <div class="layui-inline">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <select name="where[status]" id="">
                                    <option value="">全部</option>
                                    {%html_options options=PcNoticeModel::STATUS%}
                                </select>
                            </div>
                        </div>
                        <div class="layui-inline">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <select name="visible_type" data-value="{{=d.visible_type }}">
                        {%html_options options=PcNoticeModel::VISIBLE_TYPE%}
                    </select>
                </div>
            </div>
