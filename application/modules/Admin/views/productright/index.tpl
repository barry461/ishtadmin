                ...
                <div class="layui-card-body">
                    <table class="layui-table"
                        ...
                        <tr>
                            ...
                            <th lay-data="{field:'name'}">权益名称</th>
                            <th lay-data="{field:'img_url' , templet:'#img_url',width: 110}">图片</th>
                            <th lay-data="{field:'desc'}">权益描述</th>
...
<script type="text/html" class="data-dialog" id="user-edit-dialog">
    ...
    <form class="layui-form form-dialog" action="" lay-filter="form-save">
        <div class="layui-form-item">
            <label class="layui-form-label">权益名称</label>
            <div class="layui-input-block">
                <input lay-verify="required" placeholder="权益名称" name="name" value="{{=d.name }}" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-inline">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input lay-verify="required" placeholder="权益描述" name="desc" value="{{=d.desc }}" class="layui-input">
            </div>
        </div>
