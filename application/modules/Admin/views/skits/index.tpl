                ...
                <div class="layui-card-body">
                    <table class="layui-table"
                        ...
                        <tr>
                            ...
                            <th lay-data="{field:'is_open_str'}">特惠开关</th>
                            <th lay-data="{field:'coins'}">特惠价格</th>
                            <th lay-data="{field:'buy_num'}">购买次数</th>
                            <th lay-data="{field:'buy_coins'}">购买总金币</th>
                    ...
                    <script type="text/html" id="operate-toolbar">
                        <div class="operate-toolbar">
                            <a href="javascript:;" lay-event="episode" data-id="{{d.id}}"></i>剧集管理</a> |
...
<script type="text/html" class="data-dialog" id="user-edit-dialog">
    ...
    <form class="layui-form form-dialog" action="" lay-filter="form-save">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                {%html_textarea name='desc' value='{{=d.desc }}'%}
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <input placeholder="更新提示" name="update_text"
                       value="{{=d.update_text }}" class="layui-input">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                <label class="layui-form-label">特惠开关：</label>
                <div class="layui-input-inline">
                    <select name="is_open" data-value="{{=d.is_open }}">
                        {%html_options options=SkitsModel::OPEN_TIPS%}
                    </select>
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    ...
                    <input placeholder="特惠价格" name="coins"
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">特惠提示：</label>
            <div class="layui-input-block">

                <input placeholder="特惠提示" name="fee_text"
                       value="{{=d.fee_text }}" class="layui-input">
                ...
                table.on('tool(table-toolbar)', function (obj) {
                    ...
                    switch (layEvent) {
                        ...
                        case 'episode':
                            ...
                            lazy('')
                                .iframe('{%url('episode/index')%}?p_id=' + data['id'])
                                .area([`${ddd.clientWidth - 150}px`, `${ddd.clientHeight}px`])
