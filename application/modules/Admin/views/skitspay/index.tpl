                    ...
                    <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                               ...
                                               autocomplete="off" class="layui-input">
                                                    ...
                                                    <div class="layui-inline">
                                <label class="layui-form-label">类型 1单集 2合集</label>
                                <div class="layui-input-block">
                                               ...
                                               autocomplete="off" class="layui-input">
                                                    ...
                                                    <div class="layui-inline">
                                <label class="layui-form-label">单集ID/合集ID</label>
                                <div class="layui-input-block">
                                                                            <input type="text" name="search[cid]" placeholder="请输入"
                                               autocomplete="off" class="layui-input">
                                                                    </div>
                            </div>
                                                    <div class="layui-inline">
                    ...
                    <table class="layui-table"
                        ...
                        <tr>
                            <th lay-data="{type:'checkbox'}"></th>
                                                            ...
                                                            <th lay-data="{field:'type'}">类型 1单集 2合集</th>
                                                            <th lay-data="{field:'cid'}">单集ID/合集ID</th>
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                                                    ...
                                                    <input                                     placeholder="类型 1单集 2合集" name="type"
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                                                    ...
                                                    <input                                     placeholder="单集ID/合集ID" name="cid"
