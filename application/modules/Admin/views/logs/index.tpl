            ...
            <div class="layui-card">
                ...
                <div class="layui-form layui-card-header layuiadmin-card-header-auto">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            <label class="layui-form-label">sever_refer_host</label>
                            <div class="layui-input-block">
                                <input type="text" name="where[http_refer_host]" placeholder="请输入"
                                       autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline">
                            <label class="layui-form-label">line host</label>
                            <div class="layui-input-block">
                                <input type="text" name="where[line_host]" placeholder="请输入"
                                       autocomplete="off" class="layui-input">
                            </div>
                        </div>
                ...
                <div class="layui-card-body">
                    <table class="layui-table"
                        ...
                        <tr>
                            ...
                            <th lay-data="{field:'type'}">类型，error,success</th>
                            <th lay-data="{field:'ip'}">ip</th>
                            <th lay-data="{field:'ua'}">ua</th>
                            <th lay-data="{field:'http_refer_host'}">sever_refer_host</th>
                            <th lay-data="{field:'http_refer_url'}">sever_refer_url</th>
                            <th lay-data="{field:'browser_referer'}">document.refer</th>
                            <th lay-data="{field:'line_url'}">line url</th>
                            <th lay-data="{field:'line_host'}">line host</th>
                            <th lay-data="{field:'date'}">date</th>
                            <th lay-data="{field:'created'}">created</th>
                            </th>
                        </tr>
                        </thead>
                    </table>
