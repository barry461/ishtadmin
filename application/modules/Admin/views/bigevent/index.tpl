                ...
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="operate-toolbar">
                        <div class="operate-toolbar">
                            <a href="javascript:;" lay-event="relation" data-id="{{d.id}}"></i>事件管理</a> |
    ...
    <form class="layui-form form-dialog" action="" lay-filter="form-save">
        ...
        <div class="layui-form-item">
                <label class="layui-form-label">介绍：</label>
                    <div class="layui-input-block">
                        <textarea lay-verify="required" rows="25" name="desc" placeholder="介绍" class=layui-textarea>{{=d.desc }}</textarea>
                    </div>
        </div>
                    ...
                    switch (layEvent) {
                        ...
                        case 'edit':
                            lazy('#user-edit-dialog')
                                .data(data)
                                .area([1100 + 'px', document.body.offsetHeight - 50 + 'px'])
                        ...
                        case 'relation':
                            ...
                            lazy('')
                                .iframe('{%url('bigrelation/index')%}?big_id=' + data['id'])
