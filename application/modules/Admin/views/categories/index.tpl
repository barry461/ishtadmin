                ...
                <div class="layui-card-body">
                    <table class="layui-table"
                        ...
                        <tr>
                            ...
                            <th lay-data="{field:'name'}">类别名称</th>
                            <th lay-data="{field:'slug'}">别名</th>
                            <th lay-data="{field:'seo_title'}">seo标题</th>
                            <th lay-data="{field:'seo_keywords'}">seo_关键词</th>
                            <th lay-data="{field:'seo_description'}">seo_描述</th>
                            <th lay-data="{field:'description'}">描述</th>
                            <th lay-data="{field:'sort_order'}">排序</th>
    ...
    <form class="layui-form form-dialog" action="" lay-filter="form-save">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    ...
                    <input placeholder="slug" name="slug"
                           value="{{=d.slug }}" class="layui-input" >
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <select name="sort_column" data-val>
                        ...
                        {%html_options selected=data_get($customsort_options,'d.sort_column') options=$customsort_options%}
                    </select>
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item">
           <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <textarea name="seo_title" class="layui-textarea">{{=d.seo_title}}</textarea>
                </div>
            </div>
        </div>  
         ...
         <div class="layui-form-item">
           <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <textarea name="seo_keywords" class="layui-textarea">{{=d.seo_keywords}}</textarea>
                </div>
            </div>
        </div>  
         ...
         <div class="layui-form-item">
           <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <textarea name="seo_description" class="layui-textarea">{{=d.seo_description}}</textarea>
                </div>
            </div>
        </div>  
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    ...
                    <input placeholder="order" name="sort_order"
                           value="{{=d.sort_order }}" class="layui-input">
