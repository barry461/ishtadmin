                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <select name="where[lottery_status]" id="">
                                    ...
                                    {%html_options options=LotteryModel::STATUS_TIPS%}
                                </select>
                            </div>
                        </div>
                ...
                <div class="layui-card-body">
                    <table class="layui-table"
                        ...
                        <tr>
                            ...
                            <th lay-data="{field:'lottery_name',width:'10%'}">标题</th>
                            <th lay-data="{field:'lottery_begin',width:'8%',align:'center'}">开始时间</th>
                            <th lay-data="{field:'lottery_end',width:'8%',align:'center'}">结束时间</th>
                            <th lay-data="{field:'lottery_num',width:'8%',align:'center'}">开奖次数</th>
                            <th lay-data="{field:'status_str',width:'8%',align:'center'}">状态</th>
                            <th lay-data="{field:'created_at',width:'15%',templet:'#show-time'}">创建时间</th>
                            <th lay-data="{field:'updated_at',width:'14.5%',templet:'#attr2'}">更新时间</th>
...
<script type="text/html" class="data-dialog" id="user-edit-dialog">
    ...
    <form class="layui-form form-dialog" action="" lay-filter="form-save">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input lay-verify="required" placeholder="标题" name="lottery_name" value="{{=d.lottery_name }}" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="lottery_begin" class="layui-input x-date-time-full" placeholder="yyyy-MM-dd HH:mm:ss" value="{{=d.lottery_begin}}">
                    </div>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="lottery_end" class="layui-input x-date-time-full" placeholder="yyyy-MM-dd HH:mm:ss" value="{{=d.lottery_end}}">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                <label class="layui-form-label">状态</label>
                <div class="layui-input-inline">
                    <select name="lottery_status" data-value="{{=d.lottery_status }}">
                        {%html_options options=LotteryModel::STATUS_TIPS%}
                    </select>
                </div>
            </div>
