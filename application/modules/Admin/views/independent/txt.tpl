                ...
                <div class="layui-col-md9 left-panel">
                    ...
                    <div class="layui-form-item" id="article-link-display">
                        ...
                        <div class="layui-input-block">
                            <div class="layui-input" style="background-color: #f8f8f8; color: #999; cursor: pointer; border: 1px solid #e6e6e6; position: relative;">
                                <span id="article-link-text" onclick="copyArticleLink()">{%trim(options('siteUrl'),"/")%}/{%$post->slug%}.html</span>
                                <i class="layui-icon layui-icon-file" onclick="copyArticleLink()" style="position: absolute; right: 10px; top: 50%; transform: translateY(-50%); cursor: pointer; color: #1E9FFF;"></i>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="layui-tab-content">
                                ...
                                <div class="layui-tab-item layui-show">
                                        ...
                                        <div class="layui-card-body">
                                            <select name="status" lay-verify="required">
                                                {%foreach \ContentsModel::STATUS as $key => $value%}
                                                    <option value="{%$key%}" {%if isset($post) && $post->status == $key%}selected{%/if%}>
                                                        {%$value%}
                                                    </option>
                                                {%/foreach%}
                                            </select>
                                    ...
                                    <div class="layui-card">
                                        ...
                                        <div class="layui-card-body">
                                            <input type="number" name="home_top" value="{%if isset($post->home_top) && $post->home_top !== null%}{%$post->home_top%}{%else%}0{%/if%}" 
                                                placeholder="数值越大越靠前" class="layui-input" 
        ...
        layui.use(['form', 'jquery', 'laydate', 'upload', 'element'], function () {
            ...
            function autoSave() {
                ...
                const submitData = {
                    ...
                    allowFeed: allowFeed,
                    home_top: (function() {
                        const val = $('input[name="home_top"]').val();
                        return val === '' || val === null || val === undefined ? null : parseInt(val) || 0;
                    })()
                };
