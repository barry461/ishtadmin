                    ...
                    <div class="layui-form-item" id="article-link-display" style="display: none;">
                        ...
                        <div class="layui-input-block">
                            <div class="layui-input"
                                ...
                                <span id="article-link-text" onclick="copyArticleLink()" title="点击复制链接">{%trim(options('siteUrl'),"/")%}/</span>
                                ...
                                <div class="layui-tab-item layui-show">
                                    ...
                                    <div class="layui-card">
                                        ...
                                        <div class="layui-card-body">
                                            ...
                                            <div id="pageUrlConfig" style="margin-top: 10px;">
                                                <div class="layui-form-item">
                    ...
                    success: function (res) {
                        if (res.code === 0) {
                            ...
                            if (res.data && res.data.cid && !currentCid) {
                                ...
                                const pageSlug = $('input[name="page_slug"]').val().trim();
                                // 显示文章链接
                                $('#article-link-text').text(url+"/"+(pageSlug || currentCid)+".html")
