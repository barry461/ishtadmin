                ...
                <div class="layui-form layui-card-header layuiadmin-card-header-auto">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <select name="where[user_type]" id="">
                                    <option value="">全部</option>
                                    {%html_options options=TaskEmailModel::USER_TYPE_TIPS%}
                                </select>
                            </div>
                        </div>
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <select name="where[status]" id="">
                                    <option value="">全部</option>
                                    {%html_options options=TaskEmailModel::STATUS_TIPS%}
                                </select>
                            </div>
                        </div>
                        <div class="layui-inline">
                ...
                <div class="layui-card-body">
                    <table class="layui-table"
                        ...
                        <tr>
                            ...
                            <th lay-data="{field:'title'}">任务名称</th>
                            <th lay-data="{field:'user_type_str'}">用户类型</th>
                            <th lay-data="{field:'send_time'}">执行时间</th>
                            <th lay-data="{field:'cid'}">文章ID</th>
                            <th lay-data="{field:'status_str'}">状态</th>
                            <th lay-data="{field:'suc_ct'}">成功条数</th>
                            <th lay-data="{field:'fail_ct'}">失败数</th>
...
<script type="text/html" class="data-dialog" id="user-edit-dialog">
    ...
    <form class="layui-form form-dialog" action="" lay-filter="form-save">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input placeholder="任务名称" name="title"
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                <label class="layui-form-label">执行时间<整点执行>：</label>
                <div class="layui-input-inline">
                    <input type="text" name="send_time" class="layui-input x-date-time-full" placeholder="yyyy-MM-dd HH:mm:ss" value="{{=d.send_time}}">
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                <label class="layui-form-label">用户类型：</label>
                <div class="layui-input-inline">
                    <select name="user_type" data-value="{{=d.user_type }}" lay-filter="category">
                        {%html_options options=TaskEmailModel::USER_TYPE_TIPS%}
                    </select>
                </div>
            </div>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                <label class="layui-form-label">状态：</label>
                <div class="layui-input-inline">
                    <select name="status" data-value="{{=d.status }}" lay-filter="category">
                        {%html_options options=TaskEmailModel::STATUS_TIPS%}
                    </select>
                </div>
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input placeholder="发送标题" name="send_title"
                       value="{{=d.send_title }}" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                {%html_textarea name='send_content' value='{{d.send_content }}'%}
            </div>
        </div>
