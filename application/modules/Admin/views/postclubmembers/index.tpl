                    ...
                    <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                               ...
                                               autocomplete="off" class="layui-input">
                                                    ...
                                                    <div class="layui-inline">
                                <label class="layui-form-label">club_id</label>
                                <div class="layui-input-block">
                                                                            <input type="text" name="search[club_id]" placeholder="请输入"
                                               autocomplete="off" class="layui-input">
                                                                    </div>
                            </div>
                                                    <div class="layui-inline">
                                <label class="layui-form-label">club_aff</label>
                                <div class="layui-input-block">
                                                                            <input type="text" name="search[club_aff]" placeholder="请输入"
                                               autocomplete="off" class="layui-input">
                                                                    </div>
                            </div>
                                                    <div class="layui-inline">
                                ...
                                <div class="layui-input-block">
                                               ...
                                               autocomplete="off" class="layui-input">
                                                    ...
                                                    <div class="layui-inline">
                                <label class="layui-form-label">expired_at</label>
                                <div class="layui-input-block">
                                                                            <input type="text" name="search[expired_at]" placeholder="请输入"
                                               autocomplete="off" class="layui-input">
                                                                    </div>
                            </div>
                                                    <div class="layui-inline">
                    ...
                    <table class="layui-table"
                        ...
                        <tr>
                            <th lay-data="{type:'checkbox'}"></th>
                                                            ...
                                                            <th lay-data="{field:'club_id'}">club_id</th>
                                                            <th lay-data="{field:'club_aff'}">club_aff</th>
                                                            <th lay-data="{field:'type'}">type</th>
                                                            <th lay-data="{field:'expired_at'}">expired_at</th>
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                                                    ...
                                                    <input lay-verify="required"                                    placeholder="club_id" name="club_id"
                                    value="{{=d.club_id }}" class="layui-input">
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                                                    ...
                                                    <input lay-verify="required"                                    placeholder="club_aff" name="club_aff"
                                    value="{{=d.club_aff }}" class="layui-input">
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                                                    ...
                                                    <input lay-verify="required"                                    placeholder="type" name="type"
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                                                    ...
                                                    <input lay-verify="required"                                    placeholder="expired_at" name="expired_at"
                                    value="{{=d.expired_at }}" class="layui-input">
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                                                    ...
                                                    <input lay-verify="required"                                    placeholder="updated_at" name="updated_at"
