            ...
            <div class="layui-card">
                ...
                <div class="layui-form layui-card-header layuiadmin-card-header-auto">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <select name="where[relate_type]" id="">
                                    <option value="">全部</option>
                                    {%html_options options=PostMediaModel::TYPE_RELATE_TIPS selected=$relateType%}
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="where[pid]" placeholder="请输入" value="{%$pid%}"
                                       autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <select name="where[type]" id="">
                                    <option value="">全部</option>
                                    {%html_options options=PostMediaModel::TYPE_TIPS selected=$type%}
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <select name="where[status]" id="">
                                    <option value="">全部</option>
                                    {%html_options options=PostMediaModel::STATUS_TIPS%}
                                </select>
                            </div>
                        </div>
                ...
                <div class="layui-card-body">
                    <table class="layui-table"
                           lay-data="{url:'{%url('listAjax')%}',where:{'where[relate_type]':'{%$relateType%}','where[pid]':'{%$pid%}','where[type]':'{%$type%}'}, page:true, limit:90, id:'test',toolbar:'#toolbar'}"
                        ...
                        <tr>
                            ...
                            <th lay-data="{field:'type_str'}">资源类型</th>
                            <th lay-data="{templet:'#show'}">查看</th>
                            <th lay-data="{field:'relate_type_str'}">关联类型</th>
                            <th lay-data="{field:'pid'}">帖子/评论ID</th>
                            <th lay-data="{field:'status_str'}">资源处理状态</th>
...
<script type="text/html" id="show">
    <div style="line-height: normal">
        <img style="display: inline-block;width: 25px;max-height:25px;margin-bottom: 3px;"
             onclick="clickShow(this,{{d.type}},'{{d.thumb}}','{{d.media_url}}',{{d.thumb_width}},{{d.thumb_height}})"
             src="{{=d.thumb}}">
    </div>
</script>
...
<script type="text/html" class="data-dialog" id="user-edit-dialog">
    ...
    <form class="layui-form form-dialog" action="" lay-filter="form-save">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <select name="relate_type" data-value="{{=d.relate_type }}">
                        {%html_options options=PostMediaModel::TYPE_RELATE_TIPS%}
                    </select>
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">关联ID：</label>
            <div class="layui-input-block">
                <input lay-verify="required" placeholder="pid" name="pid"
                       value="{{=d.pid }}" class="layui-input">
            </div>
        </div>
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <select name="type" data-value="{{=d.type }}">
                        {%html_options options=PostMediaModel::TYPE_TIPS%}
                    </select>
                </div>
            </div>
        </div>
...
<script>
    ...
    function clickShow(obj, type, img, video, w, h) {
        let html = '';
        if (type == 1) {
            html += "<img src='" + img + "' style='width:auto;height:auto; max-width:100%;max-height:100%;'/>";
        } else {
            if (video.substr(-4) !== '.mp4') {
                previewVideo(video);
                return;
            }
