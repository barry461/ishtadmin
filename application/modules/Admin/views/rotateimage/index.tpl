                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <select name="where[status]" id="">
                                    ...
                                    {%html_options options=RotateImagesModel::STATUS%}
                                </select>
                            </div>
                        </div>
                ...
                <div class="layui-card-body">
                    <table class="layui-table"
                        ...
                        <tr>
                            ...
                            <th lay-data="{field:'title',width:'10%'}">图片标题</th>
                            <th lay-data="{field:'description'}">图片描述</th>
                            <th lay-data="{templet:'#photolist',width:'10%'}">图片</th>

                            <th lay-data="{field:'status_str'}">状态</th>

                            <th lay-data="{field:'sort'}">排序</th>
                            <th lay-data="{field:'created_at',width:'13%',templet:'#show-time'}">投放时间</th>
                            <th lay-data="{field:'created_at',width:'10.7%',templet:'#attr2'}">创建时间</th>
                            <th lay-data="{field:'updated_at',width:'10.7%',templet:'#attr3'}">更新时间</th>
