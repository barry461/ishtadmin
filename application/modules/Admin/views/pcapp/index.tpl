                ...
                <div class="layui-form layui-card-header layuiadmin-card-header-auto">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="where[name]" placeholder="请输入类型名称"
                                       autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="where[url]" placeholder="请输入跳转地址"
                                       autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <select name="where[type]" id="">
                                    ...
                                    {%html_options options=PcAppModel::TYPE_TIPS%}
                                </select>
                            </div>
                        </div>
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <select name="where[category_id]" id="">
                                    <option value="">全部</option>
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <select name="where[status]" id="">
                                    <option value="">全部</option>
                                    {%html_options options=PcAppModel::STATUS_TIPS%}
                                </select>
                            </div>
                        </div>
                        <div class="layui-inline">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <select name="orderBy[url]" lay-search="">
                                    <option value="">无</option>
                                    <option value="desc">降序</option>
                                    <option value="asc">升序</option>
                                </select>
                ...
                <div class="layui-card-body">
                    <table class="layui-table"
                        ...
                        <tr>
                            ...
                            <th lay-data="{templet:'#photolist',width:120}">LOGO</th>
                            <th lay-data="{field:'name',align:'center'}">名称</th>
                            <th lay-data="{field:'intro'}">描述</th>
                            <th lay-data="{field:'type_str',align:'center'}">产品类型</th>
                            <th lay-data="{field:'category_str',align:'center'}">所属类型</th>
                            <th lay-data="{field:'url',align:'center'}">跳转地址</th>
                            <th lay-data="{field:'status_str',align:'center'}">状态</th>
                            <th lay-data="{field:'click_num',align:'center',sort:true}">点击量</th>
    ...
    <form class="layui-form form-dialog" action="" lay-filter="form-save">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                <label class="layui-form-label">所属类型</label>
                <div class="layui-input-block">
                    <select name="category_id" data-value="{{d.category_id}}">
                        {%html_options options=$categories%}
                    </select>
                </div>
            </div>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                <label class="layui-form-label">地址：</label>
                <div class="layui-input-inline">
                    <input style="width: 490px" name="url" value="{{=d.url }}" placeholder="跳转地址"
                           lay-verify="required"
                           class="layui-input">
                </div>
            </div>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-block">
                    <input name="click_num" value="{{d.click_num || 0 }}" placeholder="点击量" lay-verify="required"
                           class="layui-input">
                </div>
            </div>
        </div>
