                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="where[title]" placeholder="请输入"
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="where[link]" placeholder="请输入"
                                       autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <select name="where[status]">
                                    {%html_options options=AdvertModel::STATUS_OPT%}
                                </select>
                            </div>
                        </div>
                         ...
                         <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <select name="where[position]">
                                    ...
                                    {%html_options options=AdvertModel::POSITION_OPT%}
                                </select>
                            </div>
                        </div>
                        <div class="layui-inline">
                ...
                <div class="layui-card-body">
                    <table class="layui-table"
                        ...
                        <tr>
                            ...
                            <th lay-data="{field:'id'}">mid</th>
                            <th lay-data="{field:'title'}">广告名称</th>
                            <th lay-data="{field:'link'}">链接</th>
                            <th lay-data="{templet:'#photolist',width:'13%'}">图片地址</th>
                            <th lay-data="{field:'position_str'}">位置</th>
                            <th lay-data="{field:'category_name'}">类型</th>
                            <th lay-data="{field:'sort'}">排序</th>
                            <th lay-data="{field:'status_str'}">状态</th>
                             <th lay-data="{field:'created_at'}">日期</th>
                    ...
                    <script type="text/html" id="toolbar">
                        <!--<div class="layui-btn-container">
                            ...
                            <button class="layui-btn layui-btn-sm" lay-event="replace"
                                    data-pk="id">批量更新链接
                            </button>
                        </div>-->
                    </script>
...
<script type="text/html" id="photolist">
    <div style="line-height: normal">
        <img style="display: inline-block;width: 25px;height: 25px;margin: 3px auto" onclick="clickShowImage(this)"
             src="{{=d.img_url_full}}">
    </div>
</script>
          ...
          <div class="layui-form-item">
            ...
            <div class="layui-inline">
              ...
              <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <select name="category" data-value="{{=d.category }}">
                        <option value="">请选择应用类型</option>
                        {%html_options options=AdvertModel::getAdvertCategoryOptions()%}
                    </select>
                </div>
            </div>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    ...
                    <input placeholder="link" name="slug"
                           value="{{=d.link }}" class="layui-input" >
                </div>
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    ...
                    <input placeholder="sort" name="sort"
            ...
            table.on('toolbar(table-toolbar)', function (obj) {
                ...
                switch (layEvent) {
                    ...
                    case 'replace':
                        ...
                        $(".layui-layer-content input").attr({'placeholder': '输入原链接地址'})
                        $(".layui-layer-content").append("<br/><input type='text' id='to' class='layui-input' placeholder='输入新链接地址'/>")
                        break;
                }
            });
            // 监听单元格编辑
