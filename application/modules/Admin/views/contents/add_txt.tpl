                ...
                <div class="layui-col-md9 left-panel">
                    ...
                    <div class="layui-form-item" style="position: relative;">
                        <input type="text" name="title" value="" required lay-verify="required" placeholder="请输入标题"
                            autocomplete="off" class="layui-input layui-bg-gray" style="font-size: 18px;">
                        <!-- 自动保存状态显示 -->
                        <div id="auto-save-status" style="position: absolute; top: 50%; right: 10px; transform: translateY(-50%); background: rgba(0,0,0,0.7); color: white; padding: 6px 10px; border-radius: 3px; font-size: 11px; z-index: 9999; display: none;">
                            <i class="layui-icon layui-icon-ok"></i> <span id="auto-save-text">已保存</span>
                        </div>
                    </div>
                    
                    <!-- 文章链接显示 -->
                    <div class="layui-form-item" id="article-link-display" style="display: none;">
                        ...
                        <div class="layui-input-block">
                            <div class="layui-input"
                                ...
                                <span id="article-link-text" onclick="copyArticleLink()" title="点击复制链接">{%trim(options('siteUrl'),"/")%}/archives/</span>
...
{%*                                <span id="article-id-placeholder" style="color: #ccc;">文章保存后显示ID</span>*%}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        <div class="layui-upload-drag" id="coverUpload">
                            ...
                            <div class="layui-hide" id="coverPreview">
                                <img src="" alt="封面预览" style="max-width: 100%; max-height: 200px;">
                            </div>
                        </div>
                    ...
                    <div class="layui-form-item layui-form-text">
                        <div id="test-editormd">
                            <textarea style="display:none;" name="content" id="editor-content"></textarea>
                        </div>
                    </div>
                        ...
                        <div class="layui-card-body" id="custom-fields-content" style="display: none;">
                            ...
                            <div class="layui-row layui-col-space10">
                                <div class="layui-col-md5">
                                    <input type="text" name="banner" value="banner" placeholder="跳转到哪里"
                                        class="layui-input">
                                </div>
                                <div class="layui-col-md7">
                                    <input type="text" id="bannerValue" placeholder="字段值" class="layui-input">
                                </div>
                            </div>
                            <div id="custom-fields"></div>
                            <div class="layui-row layui-col-space10">
                                <div class="layui-col-md5">
                                    <input type="text" name="contentLang" value="contentLang" placeholder="跳转到哪里"
                                        class="layui-input">
                                </div>
                                <div class="layui-col-md7">
                                    <input type="text" placeholder="字段值" class="layui-input">
                                </div>
                            </div>
                            <div id="custom-fields"></div>
                            <div class="layui-row layui-col-space10">
                                <div class="layui-col-md5">
                                    <input type="text" name="disableBanner" value="disableBanner" placeholder="跳转到哪里"
                                        class="layui-input">
                                </div>
                                <div class="layui-col-md7">
                                    <input type="text" placeholder="字段值" class="layui-input">
                            ...
                            <div class="layui-row layui-col-space10">
                                <div class="layui-col-md5">
                                    <input type="text" name="headTitle" value="headTitle" placeholder="跳转到哪里"
                                        class="layui-input">
                                </div>
                                <div class="layui-col-md7">
                                    <input type="text" placeholder="字段值" class="layui-input">
                            ...
                            <div class="layui-row layui-col-space10">
                                <div class="layui-col-md5">
                                    <input type="text" name="hotSearch" value="hotSearch" placeholder="跳转到哪里"
                                        class="layui-input">
                                </div>
                                <div class="layui-col-md7">
                                    <input type="text" placeholder="字段值" class="layui-input">
                            ...
                            <div class="layui-row layui-col-space10">
                                <div class="layui-col-md5">
                                    <input type="text" name="redirect" value="redirect" placeholder="跳转到哪里"
                                        class="layui-input">
                                </div>
                                <div class="layui-col-md7">
                                    <input type="text" placeholder="字段值" class="layui-input">
                            ...
                            <div class="layui-tab-content">
                                ...
                                <div class="layui-tab-item layui-show">
                                    ...
                                    <div class="layui-card">
                                        ...
                                        <div class="layui-card-body">
                                            <input type="checkbox" name="allowComment" title="允许评论" value="1" checked>
                                            <input type="checkbox" name="allowPing" title="允许被引用" value="1" checked>
                                            <input type="checkbox" name="allowFeed" title="允许在聚合中出现" value="1" checked>
                                            <input type="checkbox" name="hotSearch" title="是否热搜" value="1">
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        function autoSave() {
                ...
                // 新增：热搜状态加入 custom_fields
                const hotSearchChecked = $('input[name="hotSearch"]').is(':checked');
                if (hotSearchChecked) {
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        if (res.code === 0) {
                            ...
                            // 如果是新文章，保存返回的cid
                            if (res.data && res.data.cid && !currentCid) {
                                currentCid = res.data.cid;
                                $('input[name="cid"]').val(currentCid);

                                url = "{%trim(options('siteUrl'))%}"
                                // 显示文章链接
                                $('#article-link-text').text(url+"/archives/"+currentCid)
                                $('#article-link-display').show();
                                // $('#article-id-placeholder').text(currentCid);
                            }
                            contentStatus = submitData.status
                            // 显示自动保存成功提示
        ...
        function setupContentChangeListener() {
            ...
            $('input[name="title"]').on('input', function() {
                ...
                autoSaveTimer = setTimeout(autoSave, 30000); // 标题变化后2秒自动保存
            });
            ...
            if (testEditor) {
                testEditor.cm.on('change', function() {
                    clearTimeout(autoSaveTimer);
                    autoSaveTimer = setTimeout(autoSave, 30000); // 内容变化后2秒自动保存
                });
            }
            ...
            $('select, input[type="checkbox"], input[type="text"]').on('change', function() {
                clearTimeout(autoSaveTimer);
                autoSaveTimer = setTimeout(autoSave, 30000); // 其他变化后3秒自动保存
            });
        }
      ...
      `;
            ...
            laydate.render({
                ...
                value: fmt(nowBeijing())
            });

            function nowBeijing() {
                const now = new Date();
                const utcMs = now.getTime() + now.getTimezoneOffset() * 60000; // to UTC
                const bjMs  = utcMs + 8 * 60 * 60 * 1000;                       // +8 hours
