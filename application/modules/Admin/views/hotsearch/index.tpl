            ...
            <div class="layui-card">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <select name="where[type]" id="">
                                    ...
                                    {%html_options options=HotSearchModel::ADS_TYPE%}
                                </select>
                            </div>
                        </div>
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <select name="where[status]" id="">
                                    <option value="">全部</option>
                                    {%html_options options=HotSearchModel::STATUS%}
                                </select>
                            </div>
                        </div>
                        <div class="layui-inline">
                ...
                <div class="layui-card-body">
                    <table class="layui-table"
                           lay-data="{url:'{%url('listAjax')%}',defaultToolbar:[{title:'选显',layEvent:'selected_view',icon:'layui-icon-circle'},'filter','print','exports'], page:true, id:'test',limit:20,limits:[10,20,30,40,50,60,70,80,90,1000],toolbar:'#toolbar'}"
                        ...
                        <tr>
                            ...
                            <th lay-data="{field:'type_str',align:'center'}">类型</th>
                            ...
                            <th lay-data="{field:'created_at',templet:'#attr2'}">创建时间</th>
                            <th lay-data="{fixed: 'right',align:'center', toolbar: '#operate-toolbar'}">操作
                            </th>
                        </tr>
                        </tr>
                        </thead>
...
<script type="text/html" class="data-dialog" id="user-edit-dialog">
    ...
    <form class="layui-form form-dialog" action="" lay-filter="form-save">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input lay-verify="required" placeholder="跳转地址/QQ号/微信号" name="url_config"
