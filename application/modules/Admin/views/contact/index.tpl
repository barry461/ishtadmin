                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <select name="where[position]" id="">
                                    ...
                                    {%html_options options=ContactModel::GROUP_TIPS%}
                                </select>
                            </div>
                        </div>
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <select name="where[position]" id="">
                                    <option value="">全部</option>
                                    {%html_options options=ContactModel::STATUS_TIPS%}
                                </select>
                            </div>
                        </div>
                        <div class="layui-inline">
                ...
                <div class="layui-card-body">
                    <table class="layui-table"
                        ...
                        <tr>
                            ...
                            <th lay-data="{templet:'#photolist'}">图片</th>
                            <th lay-data="{field:'show_val'}">显示值</th>
                            <th lay-data="{field:'url'}">联系方式</th>
                            <th lay-data="{field:'group_str'}">分组标识</th>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    ...
                    <input lay-verify="required" placeholder="显示" name="show_val"
                           value="{{=d.show_val }}" class="layui-input">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    ...
                    <input lay-verify="required" placeholder="联系方式" name="url"
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    ...
                    <select name="group" data-value="{{=d.group }}">
                        {%html_options options=ContactModel::GROUP_TIPS%}
                    </select>
