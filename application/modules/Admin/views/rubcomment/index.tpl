            ...
            <div class="layui-card">
                ...
                <div class="layui-form layui-card-header layuiadmin-card-header-auto">
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            <label class="layui-form-label">文章/帖子ID</label>
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <select name="where[type]" id="">
                                    ...
                                    {%html_options options=RubCommentModel::TYPE_TIPS %}
                                </select>
                            </div>
                        </div>
                ...
                <div class="layui-card-body">
                    <table class="layui-table"
                           lay-data="{url:'{%url('listAjax')%}', limit:90, page:true, id:'test',toolbar:'#toolbar'}"
                           lay-filter="table-toolbar">
                        <thead>
                        <tr>
                            <th lay-data="{type:'checkbox'}"></th>
                            <th lay-data="{field:'nickname',width:120}">昵称</th>
                            <th lay-data="{field:'comment',width:350}">内容</th>
                            <th lay-data="{field:'id',width: 100 }">ID</th>
                            <th lay-data="{field:'p_id',width: 100 }">文章/帖子ID</th>
                            <th lay-data="{field:'aff',width: 100 }">aff</th>
                            <th lay-data="{field:'type_str',width: 100}">类型</th>
                            <th lay-data="{field:'ipstr',width: 170}">IP</th>
                            <th lay-data="{field:'cityname',width: 150}">城市</th>
                    ...
                    <script type="text/html" id="toolbar">
                        <div class="layui-btn-container">
                            ...
                            <button class="layui-btn layui-btn-sm" lay-event="delAll" data-pk="id">删除全部</button>
                            <button class="layui-btn layui-btn-sm" lay-event="passBatch" data-pk="id">批量通过</button>
                        </div>
                    </script>
            ...
            switch (layEvent) {
                ...
                case 'passBatch':
                    ...
                    layer.confirm('真的通过吗?', function (index) {
                        layer.close(index);
                        $.post("{%url('passBatch')%}", {"value": pkValAry.join(',')})
                            .then(function (json) {
                                if (json.code) {
                                    Util.msgErr(json.msg);
                                } else {
