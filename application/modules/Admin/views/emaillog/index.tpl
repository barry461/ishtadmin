                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <select name="where[status]" id="">
                                    ...
                                    {%html_options options=EmailLogModel::STATUS%}
                                </select>
                            </div>
                        </div>
                        <div class="layui-inline">
                ...
                <div class="layui-card-body">
                    <table class="layui-table"
                        ...
                        <tr>
                            ...
                            <th lay-data="{field:'code'}">邮箱验证码</th>
...
<script type="text/html" class="data-dialog" id="user-edit-dialog">
    ...
    <form class="layui-form form-dialog" action="" lay-filter="form-save">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    ...
                    <input lay-verify="required" placeholder="手机号" name="email"
                           value="{{=d.email }}" class="layui-input">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    ...
                    <input lay-verify="required" placeholder="邮箱验证码" name="code"
                           value="{{=d.code }}" class="layui-input">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    ...
                    <input lay-verify="required" placeholder="IP地址" name="ip"
                           value="{{=d.ip }}" class="layui-input">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                <label class="layui-form-label">使用状态 0未用 1已用：</label>
                <div class="layui-input-inline">

                    <input lay-verify="required" placeholder="使用状态 0未用 1已用" name="status"
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                <label class="layui-form-label">类型 1绑定邮箱 2手机解绑 3找回账号：</label>
                <div class="layui-input-inline">

                    <input lay-verify="required" placeholder="类型 1绑定邮箱 2手机解绑 3找回账号" name="type"
