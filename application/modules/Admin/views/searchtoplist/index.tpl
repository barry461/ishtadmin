    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">热搜词管理</div>
                ...
                <div class="layui-card-body">
                    <table class="layui-table"
                        ...
                        <tr>
                            ...
                            <th lay-data="{field:'name',align:'center'}">关键词</th>
                            <th lay-data="{field:'value'}">热度</th>
                    ...
                    <script type="text/html" id="operate-toolbar">
                        ...
                        <a class="layui-btn layui-btn-danger layui-btn-xs" data-name="{{=d.name}}"
                           lay-event="del">
    ...
    <form class="layui-form form-dialog" action="" lay-filter="form-save">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-block">
                    <input name="value" value="{{d.value || 0 }}" placeholder="热度" lay-verify="required"
                           class="layui-input">
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item layui-hide">
            <input type="hidden" name="_name" value="{{d.name||''}}">
                ...
                switch (layEvent) {
                    case 'del':
                        layer.confirm('真的删除吗?', function (index) {
                            layer.close(index);
                            $.post("{%url('del')%}", {"name": $(that).data('name')})
                                .then(function (json) {
                                    if (json.code) {
        ...
        table.on('toolbar(table-toolbar)', function (obj) {
            ...
            switch (layEvent) {
                ...
                case 'delSelect':
                    ...
                    layer.confirm('真的删除吗?', function (index) {
                        layer.close(index);
                        $.post("{%url('delAll')%}", {"name": pkValAry.join(',')})
                            .then(function (json) {
                                if (json.code) {
                                    Util.msgErr(json.msg);
                                } else {
