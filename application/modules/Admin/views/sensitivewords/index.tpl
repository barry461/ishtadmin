                ...
                <div class="layui-form layui-card-header layuiadmin-card-header-auto">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="search[word]" placeholder="请输入"
                                       autocomplete="off" class="layui-input">
                            </div>
                        </div>
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <select name="where[status]" id="">
                                    ...
                                    {%html_options options=SensitiveWordsModel::STATUS_TIPS%}
                                </select>
                            </div>
                        </div>
                ...
                <div class="layui-card-body">
                    <table class="layui-table"
                        ...
                        <tr>
                            ...
                            <th lay-data="{field:'status_str', width:100, align:'center', templet:'#status-tpl'}">状态</th>
                    ...
                    <script type="text/html" id="status-tpl">
                        {{# if(d.status == 1) { }}
                            <span class="layui-badge layui-bg-green">{{d.status_str}}</span>
                        {{# } else { }}
                            <span class="layui-badge layui-bg-gray">{{d.status_str}}</span>
                        {{# } }}
                    </script>
                    <script type="text/html" id="toolbar">
                        <div class="layui-btn-container">
                            ...
                            <button class="layui-btn layui-btn-sm" lay-event="clearCache"
                                    data-pk="id">清除缓存
                            </button>
                        </div>
                    </script>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    ...
                    <input lay-verify="required" placeholder="敏感词" name="word"
                           value="{{=d.word }}" class="layui-input">
...
<script type="text/html" class="data-dialog" id="import-edit-dialog">
    <fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
        <legend>信息</legend>
    </fieldset>
    <form class="layui-form form-dialog" action="" lay-filter="form-save">
        <div class="layui-form-item">
            <label class="layui-form-label">敏感词：</label>
            <div class="layui-input-block">
                <textarea placeholder="敏感词，一行一个" name="text" class="layui-textarea"></textarea>
            </div>
        </div>
        <div class="layui-form-item layui-hide">
            <button class="layui-btn submit" lay-submit="" lay-filter="save"></button>
            ...
            table.on('toolbar(table-toolbar)', function (obj) {
                ...
                switch (layEvent) {
                    case 'add':
                        ...
                        break;
                    case 'import':
                        lazy('#import-edit-dialog')
                            .area([1100 + 'px', document.body.offsetHeight + 'px'])
                            .dialog(function (id, ele) {
                                let from = $(ele).find('form')
                                $.post("{%url('import')%}", from.serializeArray())
                                    .then(function (json) {
                                        layer.close(id);
                                        Util.msgOk(json.msg);
                                        table.reload('test')
