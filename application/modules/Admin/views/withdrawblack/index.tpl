            ...
            <div class="layui-card">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <select name="where[status]">
                                    ...
                                    {%html_options options=WithdrawBlackModel::STATUS_LIST%}
                                </select>
                            </div>
                        </div>
                        <div class="layui-inline">
                ...
                <div class="layui-card-body">
                    <table class="layui-table"
                           lay-data="{url:'{%url('listAjax')%}', page:true, id:'test', limit:90,toolbar:'#toolbar'}"
                           lay-filter="table-toolbar">
                        <thead>
                        <tr>
                            <th lay-data="{field:'id',width:80}">id</th>
                            <th lay-data="{field:'created_at',templet:'#att2',width:250}">用户</th>
                            <th lay-data="{field:'status_str',width:80}">状态</th>
                            <th lay-data="{field:'reason',width:250}">拉黑理由</th>
                            <th lay-data="{field:'remark',width:250}">备注</th>
                            <th lay-data="{field:'created_at',templet:'#att3',width:250}">时间</th>
                    ...
                    <script type="text/html" id="operate-toolbar">
                        <div class="operate-toolbar">
                            {{# if(d.status == 1){ }}
                                <a href="javascript:;" lay-event="unblack" data-id="{{d.id}}">取消拉黑</a>
                            {{# } else { }}
                                ------
                            {{# } }}
                        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    ...
                    <input placeholder="拉黑理由" name="reason"
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    ...
                    <input placeholder="备注" name="remark"
                           value="{{=d.remark }}" class="layui-input">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    ...
                    <input placeholder="修改时间" name="updated_at"
                ...
                table.on('tool(table-toolbar)', function (obj) {
                    ...
                    switch (layEvent) {
                        ...
                        case 'edit':
                            ...
                            break;
                        case 'unblack':
                            layer.confirm('确认要取消用户提现黑名单身份吗?', function (index) {
                                layer.close(index);
                                $.post("{%url('unblack')%}", {"id": $(that).data('id')})
                                    .then(function (json) {
                                        if (json.code) {
                                            Util.msgErr(json.msg);
                                        } else {
