                ...
                <div class="layui-form layui-card-header layuiadmin-card-header-auto">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <select name="where[type_id]" lay-search="">
                                    <option value="">全部</option>
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <select name="where[way_id]" lay-search="">
                                    <option value="">全部</option>
                                    {%html_options options=$wayArr%}
                                </select>
                            </div>
                        </div>
                        <div class="layui-inline">
                ...
                <div class="layui-card-body">
                    <table class="layui-table"
                        ...
                        <tr>
                            ...
                            <th lay-data="{field:'product_id',templet:'#att1'}">产品</th>
                            <th lay-data="{field:'type_id',templet:'#att2'}">支付类型</th>
                            <th lay-data="{field:'way_id',templet:'#att3'}">支付网关</th>
                    ...
                    <script type="text/html" id="att1">
                        {{d.product.pname}}<span style="color: red">#{{d.product_id}}</span>
                    </script>
                    <script type="text/html" id="att2">
                        {{d.type.name}}&nbsp;<span style="color: red">#{{d.type_id}}</span>
                    </script>
                    <script type="text/html" id="att3">
                        {{d.way.name}}<span style="color: red">#{{d.way_id}}</span>
                    </script>
...
<script type="text/html" class="data-dialog" id="user-edit-dialog">
    ...
    <form class="layui-form form-dialog" action="" lay-filter="form-save">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">支付类型</label>
            <div class="layui-input-block">
                <select name="type_id" data-value="{{=d.type_id}}">
                    {%html_options options=$typeArr%}
                </select>
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">支付网关</label>
            <div class="layui-input-block">
                <select name="way_id" data-value="{{=d.way_id}}">
                    {%html_options options=$wayArr%}
                </select>
            </div>
        </div>
