...
<script type="text/html" class="data-dialog" id="user-edit-dialog">
    ...
    <form class="layui-form form-dialog" action="" lay-filter="form-save">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                {%html_textarea name='question' value='{{=d.question }}'%}
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                {%html_textarea name='answer' value='{{=d.answer }}'%}
            </div>
        </div>
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <select name="status" data-value="{{d.status}}">
                        {%html_options options=UserHelpModel::STATUS%}
                    </select>
                </div>
            </div>
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <select name="type" data-value="{{d.type}}">
                        {%html_options options=UserHelpModel::USER_HELP_TYPE%}
                    </select>
                </div>
            </div>
        </div>
