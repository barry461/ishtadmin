            ...
            <div class="layui-card">
                ...
                <div class="layui-form layui-card-header layuiadmin-card-header-auto">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline">
                            <label class="layui-form-label">包养id</label>
                            <div class="layui-input-block">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <select name="where[status]" lay-search="" >
                                    ...
                                    {%html_options options=GirlChatComplaintModel::OPTION_TYPE%}
                                </select>
                            </div>
                        </div>
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="search[content]" placeholder="请输入"
                                       autocomplete="off" class="layui-input">
                ...
                <div class="layui-card-body">
                    <table class="layui-table"
                        ...
                        <tr>
                            ...
                            <th lay-data="{field:'girl_chat_id'}">包养id</th>
                            <th lay-data="{field:'type_arr_str'}">类型</th>
                            <th lay-data="{field:'content'}">内容</th>
                            <th lay-data="{field:'reason'}">原因</th>
                            <th lay-data="{templet:'#img'}">图片</th>
                            <th lay-data="{field:'ip_str'}">ip_str</th>
                            <th lay-data="{templet:'#time'}">时间</th>
    ...
    <form class="layui-form form-dialog" action="" lay-filter="form-save">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    ...
                    <input placeholder="girl_chat_id" name="girl_chat_id"
                           value="{{=d.girl_chat_id }}" class="layui-input">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                <label class="layui-form-label">类型：</label>
                <div class="layui-input-inline">
                    <select name="status" lay-search="" data-value="{{=d.type}}">
                        <option value="">全部</option>
                        {%html_options options=GirlChatComplaintModel::OPTION_TYPE%}
                    </select>
                </div>
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <select name="status" lay-search="" data-value="{{=d.status}}">
                        <option value="">全部</option>
                        {%html_options options=GirlChatComplaintModel::STATUS%}
                    </select>
                </div>
            </div>
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    ...
                    <input placeholder="content" name="content"
                           value="{{=d.content }}" class="layui-input" disabled>
