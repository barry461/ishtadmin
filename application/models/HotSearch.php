...
class HotSearchModel extends BaseModel
{
    ...
    const CK_HOT_SEARCH_LIST = 'ck:hot:search:list';
    const GP_HOT_SEARCH_LIST = 'ck:hot:search:list:group';
    const CN_HOT_SEARCH_LIST = '热搜列表';

    public static function getOne()
    {
        $list = cached(self::CK_HOT_SEARCH_LIST)
            ->group(self::GP_HOT_SEARCH_LIST)
            ->chinese(self::CN_HOT_SEARCH_LIST)
            ->fetchPhp(function (){
                return self::selectRaw('id, title, url_config, router, type')
