 ...
 * @mixin \Eloquent
 */
class PcAppCategoryModel extends BaseModel
{
    protected $table = "pc_app_category";
    ...
    const REDIS_KEY = 'pc:app:categories';
    const REDIS_KEY_GROUP = 'pc:gp:app:categories';
