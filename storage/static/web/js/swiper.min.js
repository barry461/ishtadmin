...
!function(e, t) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : (e = e || self).Swiper = t()
        ...
        var h = {
            ...
            updateSlides: function() {
                ...
                if (void 0 !== s) {
                    ...
                    for (var S, M = e.slidesPerColumn, P = T / M, z = Math.floor(h / e.slidesPerColumn), k = 0; k < h; k += 1) {
                        ...
                        if (e.slidesPerColumn > 1) {
                            ...
                            if ("row" === e.slidesPerColumnFill && e.slidesPerGroup > 1) {
                                ...
                                L = (I = A - (D = Math.floor(A / e.slidesPerGroup)) * e.slidesPerGroup + O * e.slidesPerGroup) + D * T / M,
                                    $.css({
                    ...
                    e.slidesPerColumn > 1 && (this.virtualSize = (C + e.spaceBetween) * T,
        ...
        var m, g, b, w, y, x, E, T, C, S, M, P, z, k, $, L = {
            ...
            $ = "MacIntel" === m,
        !E && $ && o.touch && (1024 === w && 1366 === y || 834 === w && 1194 === y || 834 === w && 1112 === y || 768 === w && 1024 === y) && (E = g.match(/(Version)\/([\d.]+)/),
            $ = !1),
            b.ie = S,
            b.edge = M,
            b.firefox = P,
        ...
        (E || C || T) && (b.os = "ios",
            b.ios = !0),
        C && !T && (b.osVersion = C[2].replace(/_/g, "."),
            b.iphone = !0),
        E && (b.osVersion = E[2].replace(/_/g, "."),
            b.ipad = !0),
        T && (b.osVersion = T[3] ? T[3].replace(/_/g, ".") : null,
            b.ipod = !0),
        b.ios && b.osVersion && g.indexOf("Version/") >= 0 && "10" === b.osVersion.split(".")[0] && (b.osVersion = g.toLowerCase().split("version/")[1].split(" ")[0]),
            b.webView = !(!(C || E || T) || !g.match(/.*AppleWebKit(?!.*Safari)/i) && !t.navigator.standalone) || t.matchMedia && t.matchMedia("(display-mode: standalone)").matches,
            b.webview = b.webView,
                    ...
                    if (i.allowTouchCallbacks && this.emit("touchMove", l),
                        ...
                        if (!(this.params.threshold && Math.sqrt(Math.pow(p, 2) + Math.pow(c, 2)) < this.params.threshold)) {
                            ...
                            if (void 0 === i.isScrolling)
                                this.isHorizontal() && r.currentY === r.startY || this.isVertical() && r.currentX === r.startX ? i.isScrolling = !1 : p * p + c * c >= 25 && (u = 180 * Math.atan2(Math.abs(c), Math.abs(p)) / Math.PI,
