(function (w) {
            ...
            tableIns = table.render({
                ...
                page: true,
                    ...
                    table.on('toolbar(' + filterName + ')', function (obj) {
                        ...
                        console.warn("尝试触发:event.toolbar->" + 'toolbar.' + obj.event);
                    ...
                    Util.config('done', xx.emptyFn()).call(null, table, table.cache[this.id], form, HTTPUtil, laytpl, $)
                    setTimeout(function () {
            ...
            laytpl(formHtmlContent).render(obj.data, function (html) {
                let layoutIndex = layer.open($.extend(_config, {
                    ...
                    , success: function () {
                        ...
                        Util.formSubmit(config.saveUrl, form, HTTPUtil);
    ...
    w.reloadData = function(){
        layui.use(['HTTPUtil', 'element', 'jquery', 'table', 'laytpl', 'laydate', 'form', 'upload','layedit'], self_fn);
    }
    w.reloadData();
})(window);
